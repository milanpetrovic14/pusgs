namespace WebApp.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<WebApp.Persistence.ApplicationDbContext>
    {
        ...
        protected override void Seed(WebApp.Persistence.ApplicationDbContext context)
        {
            ...
            if (!context.TipoviPutnika.Any(b => b.Tip == "student"))
            {
                var ut = new TipPutnika()
                {
                    Tip = "student"
                };

                context.TipoviPutnika.Add(ut);
                context.SaveChanges();
            }

            if (!context.TipoviPutnika.Any(b => b.Tip == "penzioner"))
            {
                var ut = new TipPutnika()
                {
                    Tip = "penzioner"
            ...
            if (!context.TipoviPutnika.Any(b => b.Tip == "regularan"))
            {
                var ut = new TipPutnika()
                {
                    Tip = "regularan"
